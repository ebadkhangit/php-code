...
echo "<script>alert('User Name OR Email Id OR Mobile Number Already  Exist')</script>";
  ...
  $query_result="insert into user_login(display_name,user_name,user_emailid,user_mobile,mobile_2,gender,user_password,forget_password,view_password,address,experience,joining_date,dep_id,des_id,resume_image,experience_certificate,adhar_card,other_document,user_pic,other_1,other_2,other_3,other_tite1,other_tite2,other_tite3,basic_salary,hra,conveyance,allowance,esi,pf,user_type,user_status,user_create_date) values('$name','$username','$email','$mobile','$mobile2','$gender','$password','$password_encoded','$password1','$address','$experience','$joining_date','$depid','$desid','$file_path1','$file_path2','$file_path3','$file_path4','$file_path5','$file_path6','$file_path7','$file_path8','$titlename1','$titlename2','$titlename3','$basicsalary','$hra','$conveyance','$allowance','$esi','$pf','$usertype','$userstatus','$currentDate')";
